...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <foter className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">&copy; 2025 ENTNT Dental Hub. All rights reserved.</p>
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
             <p className="text-xs text-muted-foreground">
                Built by Rishav Raj Bhagat
            </p>
        </nav>
      </footer>
    </div>
